...
import de.scrupy.skywars.commands.SetLobbySpawn;
import de.scrupy.skywars.commands.TestCommand;
import de.scrupy.skywars.events.GameStateEventHandler;
import de.scrupy.skywars.events.PlayerJoin;
...
import de.scrupy.skywars.game.scoreboard.ScoreboardEvent;
import de.scrupy.skywars.game.team.TeamSelectionEvent;
...
public class SkyWars extends JavaPlugin {
    ...
    private void registerListener() {
        ...
        pluginManager.registerEvents(new PlayerJoin(messageConfig, playerAttributes, lobbySpawn), this);
        pluginManager.registerEvents(new GameStateEventHandler(this), this);
        pluginManager.registerEvents(new TeamSelectionEvent(messageConfig, teamHandler, teamSelectorGui), this);
        ...
        pluginManager.registerEvents(new ScoreboardEvent(teamHandler, kitHandler, map), this);
    }

    private void registerCommands() {
        this.getCommand("setLobbySpawn").setExecutor(new SetLobbySpawn(this, messageConfig));
        this.getCommand("test").setExecutor(new TestCommand(kitGui));
    }
